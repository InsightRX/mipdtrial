...
For this example we will draw covariate distributions from the NHANES data set,
which is based on survey data collected by the US National Center for Health
Statistics from a general sampling of the US population.

While the original data set is much larger, here we will take just the first
