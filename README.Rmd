...
```r
# sample at peak (at 1-hour infusion end), and 1 hour before true trough
...
## If you are sure the sampling times and dosing intervals are not going 
...
## target auc24 of 400-600 at day 6
...
## allow dose updates at dose #3 and #5
...
simulations. If you find an example of an MIPD trial design that cannot be 
captured yet using these functions, please let us know.
